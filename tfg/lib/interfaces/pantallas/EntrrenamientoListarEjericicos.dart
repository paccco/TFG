...
import 'package:tfg/interfaces/pantallas/EntreSeries.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        bottomNavigationBar: InkWell(
          onTap: (){
            Navigator.push(context, MaterialPageRoute(builder: (builder)=>EntreSeries(ejercicio: ejercicios[0], tipo: '11110000', primeraSerie: true)));
          },
        child: Container(
          alignment: Alignment.center,

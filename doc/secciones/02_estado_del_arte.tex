...
%aquí debería haber una subsección llamada Dominion del problema.

Antes de seguir, %Más que antes de seguir, sería "Para comenzar" 

me veo en la obligación de %Habla en impersonal o en primera persona de plural "Nos vemos en la obligación de", "Es necesario"

hablar un poco sobre conceptos generales en el mundo del deporte, definiendo algunos conceptos. Un ejercicio 
%sueles poner una coma entre el sujeto y el predicado de una frase, como en este caso, ten cuidado con eso "un ejercicio, es la..."
...
%Aquí falta que añadas varis párrafos más: uno para explicar lo de las metas, otro para explicar lo de compartir rutinas, otro sobre lo que te dije que quitaras de la introducción, con su referencia, y finalmente otro párrafo explicando que sería muy útil una aplicacion que permitiera planificar rutinas de esta forma y luego ayudar a su seguimiento o monitorización. 
...
%El párrafo siguiente no se pone aquí. En esta sección solo debes presentar qué hay, y el párrafo siguiente llevarlo al capítulo de tu propuesta. 
...
\begin{itemize}
	\item MySQL  %yo añadiría MariaDB
...
%Aquí falta una tabla comparativa de características de todas que te permita luego en tu propuesta justificar tu elección
...
%Aquí falta una tabla comparativa de más características que te permita luego en tu propuesta justificar tu elección
...
\section{Trabajos relacionados} %Esta sección no es necesaria, solo si vas a revisar artículos científicos sobre la temática
El software libre y sus licencias \cite{gplv3} ha permitido llevar a cabo una expansión del aprendizaje de la informática sin precedentes.  %¿porqué mencionas software libre?

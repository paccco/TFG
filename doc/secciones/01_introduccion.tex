...
\begin{itemize}
 ...
 %como para sus creadores  % esto no lo sabes, no lo puedes analizar, yo lo quitaría 
 ...
 %he añadido lo de móviles
	\item Desarrollar una aplicación multiplataforma que cubra todos los requisitos necesarios para dar soporte a la planificación y realización de entrenamientos y monitorización de rutinas de ejercicio físico. %he añadido lo de planificación
 %En la motivación hablas de accesibilidad, así que debería incluirla como otro objetivo. Si vas a incluir lo de la IA, también otro.
\end{itemize}
...
El 3º capítulo, %sería tu propuesta, y faltaría el cuarto capítulo de conclusiones y trabajos futuros.

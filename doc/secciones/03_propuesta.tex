...
\begin{figure}[H]
   \centering
    \includegraphics[width=0.7\textwidth]{fotos/BDL iteracion 1.png}
...
\begin{itemize}
  ...
  \item SCRUM-?? Implementar mi perfil
...
\HU{
SCRUM-?? Implementar mi perfil
}{
	\item Implementar el boceto IU \cref{fig:Opciones de perfil usuario}
	\item Añadir accesos a las funcionalidades actuales
}{
	\item si la funcionalidad seleccionada no está implementada, no hacer nada
	\item si la funcionalidad seleccionada está implementada, desplegar ventana de dicha funcionañidad
...
SCRUM-21 Crear/Borrar mi usuario
	...
	\item Implementar bocetos de IU \cref{fig:Crear cuenta 1} ,\cref{fig:Crear cuenta 2}, \cref{fig:Pagina inicial}
...
SCRUM-23 Iniciar/Cerrar sesión
	...
	\item Implementar el boceto IU \cref{fig:Inicio de sesion}
...
\begin{figure}[H]
   \centering
    \includegraphics[width=0.7\textwidth]{fotos/BDL iteracion 2.png}
